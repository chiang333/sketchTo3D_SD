...
if __name__ == '__main__':
    ...
    parser.add_argument('--sketch_path', default=None, help="sketch image path")
    parser.add_argument('--inversion_ckpt', default=None, help="inversion checkpoint path")
    ...
    save_name = opt.sketch_path.split("/")[-1].split(".")[0]

    opt.workspace += save_name + "-" + str(opt.text).replace(" ", "-")
